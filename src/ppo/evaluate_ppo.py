...
from src.ppo.models.model_ppo import FlanT5PPOFineTuner  # New import
from src.ppo.data_loader import create_dataloaders
...
def main(checkpoint_path):
    ...
    print("Actual validation columns:", val_details_df.columns.tolist())
    ...
    val_details_file = model.model_dir / f"validation_details_ppo_{timestamp}.csv"
    ...
    test_details_file = model.model_dir / f"test_details_ppo_{timestamp}.csv"
