...
from src.models.model_pg import FlanT5FineTuner
...
def setup_trainer(model_dir, max_epochs_pg, wandb_project_name="counterfactual_story_rewriting"):
    """
...
def main():
    ...
    try:
        ...
        trainer = setup_trainer(model_dir, CONFIG["max_epochs_pg"])
